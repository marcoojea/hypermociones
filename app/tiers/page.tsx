...
export const metadata: Metadata = { title: "Tier list real 2026/27", description: "Tier S+ a C por posición con minutos 2025/26, impacto, relevancia y valor de mercado trazable." };
