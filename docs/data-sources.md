...
| [API-Football coverage](https://www.api-football.com/coverage) | Fixtures, jugadores, alineaciones, standings y estadísticas según temporada | API comercial/freemium | **Proveedor inicial recomendado e implementado.** El plan gratuito anuncia 100 peticiones/día y todos los endpoints; se audita la cobertura devuelta para 2026 antes de aceptar el snapshot. |
...
## Cobertura efectiva del primer adaptador

| Campo | Estado |
| --- | --- |
| Equipos, nombres de jugadores, posición, nacionalidad, dorsal | Disponible si el plan devuelve plantillas |
...
Los [planes de API-Football](https://www.api-football.com/pricing) incluyen todos los endpoints, pero limitan temporadas y cuota. Antes de producción debe confirmarse por escrito que el uso elegido cubre la publicación prevista y cualquier derecho adicional de la competición.
